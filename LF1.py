...
def validate_dining_suggestion(location, cuisine, num_people, date, time):
    ...
    cuisines = ['thai', 'chinese', 'indian', 'american', 'mexican', 'japanese']
...
def restaurantApiCall(requestData):
    ...
    payload = ""
    headers = {
        'Authorization': "Bearer 2bmxTzMXxwdNuU031BYWHhr3oM7u3SNqagh4OEho0e7HHGWDf-kniHdBVrnAYi1Yn4j4ipZ__lm5uStqOTklsCO07mVXj7oGKRR54LOMFQ8V_mYJmrOtFPK7WwaPXHYx",
